...
const templates = [
  {
    ...
    json: {
      "ui": {
        ...
        "wantsCaptions": true,
        "durationSec": 30,
        "referenceText": "Create a viral 30-second testimonial video ad script inspired by trending food commercials. \n\nThe scene features a lively young woman sitting in her car, holding a juicy cheeseburger, speaking directly to the camera about why it’s her favorite meal — emphasizing taste, price, and convenience. \n\nFinish with a cinematic B-roll of the burger sizzling on the grill as a narrator says: “The Classic Crusty Burger — now only five ninety-nine!”",
        "research": true,
  ...
  },
  {
    ...
    json: {
      "ui": {
        ...
        "wantsCaptions": true,
        "durationSec": 60,
        "referenceText": "Latest, most impactful AI news developments over the last 48 hours.",
        "research": true,
  ...
  },
  {
    ...
    json: {
      "ui": {
        ...
        "wantsCaptions": true,
        "durationSec": 60,
        "referenceText": "Generate a 60 second children's book about a small white bunny trying to find her way home as she navigates her way through a dense forest at sunset to a clearing. She hops around asking the other animals in the forest if they could help.",
